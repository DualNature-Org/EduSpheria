...
function About() {
    return (
        <div>
            ...
            <br />
            <p className='text-2xl font px-5 py-5 font-normal text-black'>You might wonder, “Why choose EduSpheria?” The answer is simple: Quality, Integrity, and personalization.</p>
            ...
            <div className="bg-[#FF7F50] text-white py-12">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-lg sm:text-xl md:text-2xl mb-8">
                        At EduSpheria, our vision is to redefine the academic support industry by providing innovative solutions that empower students to excel in their educational journey.
                    </p>
                    <p className="text-lg sm:text-xl md:text-2xl mb-8">
