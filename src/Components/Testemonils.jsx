        ...
        <div className="mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-28">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
                <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                    ...
                    <p className='p-5 text-xl font-normal'>At EduSpheria, we take pride in delivering top-quality assignments that exceed our clients' expectations. But don't just take our word for it. Here's what some of our satisfied clients have to say:</p>
